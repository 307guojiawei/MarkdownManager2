...
(function() {
  var factory = function(exports) {
    ...
    exports.fn.imageDialog = function() {
      ...
      settings.crossDomainUpload = true; //gjw
      ...
      if (editor.find("." + dialogName).length < 1) {
          ...
          (function() {
            return settings.imageUpload
              ? '<div class="' +
                  classPrefix +
                  'file-input">' +
                  '<input id="imgUploadFileInput" type="file" name="' +
                  classPrefix +
                  'image-file" accept="image/*" />' +
                  '<input style="display:none " type="text" name="token" value="' +
                  token +
                  '"/>' +
        ...
        var submitHandler = function() {
          loading(false);
          var url = document.getElementById("resultMsgBox").innerHTML;
          dialog.find("[data-url]").val(url);
          return false;
        };

        var resultMsgBox = document.getElementById("resultMsgBox");
        resultMsgBox.addEventListener("click", submitHandler);
        ...
        fileInput.bind("change", function() {
          ...
          var parentMsgBox = document.getElementById("uploadImgBox");
